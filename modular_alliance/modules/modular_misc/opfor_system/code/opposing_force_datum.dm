...
/datum/opposing_force/proc/deny(mob/denier, reason = "")
	...
	SEND_SOUND(mind_reference.current, sound('modular_alliance/modules/modular_misc/opfor_system/sound/denied.ogg'))
...
/datum/opposing_force/proc/approve(mob/approver)
	...
	SEND_SOUND(mind_reference.current, sound('modular_alliance/modules/modular_misc/opfor_system/sound/approved.ogg'))
