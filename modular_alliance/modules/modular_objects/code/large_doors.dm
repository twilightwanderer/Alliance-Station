...
/obj/machinery/door/airlock/multi_tile/glass
	...
	icon = 'modular_alliance/modules/modular_objects/icons/large_doors/glass/multi_tile.dmi'
	overlays_file = 'modular_alliance/modules/modular_objects/icons/large_doors/glass/overlays.dmi'
	opacity = FALSE
...
/obj/machinery/door/airlock/multi_tile/metal
	name = "Large Airlock"
	icon = 'modular_alliance/modules/modular_objects/icons/large_doors/metal/multi_tile.dmi'
	overlays_file = 'modular_alliance/modules/modular_objects/icons/large_doors/metal/overlays.dmi'
