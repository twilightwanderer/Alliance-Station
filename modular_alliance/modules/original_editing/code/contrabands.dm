...
/obj/structure/sign/poster/contraband/modular_alliance
	icon = ICON_CONTRABANDS_PATH

/obj/structure/sign/poster/contraband/modular_alliance/glory_alliance
	name = "Glory Alliance"
	desc = "A poster singing dithyrambs to the human System Alliance."
	icon_state = "glory_alliance"

/obj/structure/sign/poster/contraband/modular_alliance/reapers
	name = "Reapers Lies"
	desc = "A poster claiming that the Reapers are fiction. The question of who is depicted on the poster remains open."
	icon_state = "reapers"

/obj/structure/sign/poster/contraband/modular_alliance/spectres
...
/obj/structure/sign/poster/contraband/modular_alliance/n7
	name = "N7 The TOP"
	desc = "A nice reminder from the Alliance that you are far from \"TOP\"."
	icon_state = "n7"

/obj/structure/sign/poster/contraband/modular_alliance/cerberus
