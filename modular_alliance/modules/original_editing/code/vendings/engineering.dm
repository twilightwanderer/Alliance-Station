...
/obj/machinery/vending/modular_alliance/public_engineering
	name = "\improper Public Robco Tool Maker"
	...
	refill_canister = /obj/item/vending_refill/modular_alliance/public_engineering
	default_price = PAYCHECK_CREW
	extra_price = PAYCHECK_COMMAND * 1.5
	payment_department = ACCOUNT_ENG
	light_mask = "engi-light-mask"

/obj/item/vending_refill/modular_alliance/public_engineering
	machine_name = "Public Robco Tool Maker"
