/obj/docking_port/mobile
	...
	var/takeoff_sound = sound('modular_alliance/modules/modular_shuttles/sounds/engine_startup.ogg')
	/// The landing sound to be played
	var/landing_sound = sound('modular_alliance/modules/modular_shuttles/sounds/engine_landing.ogg')
