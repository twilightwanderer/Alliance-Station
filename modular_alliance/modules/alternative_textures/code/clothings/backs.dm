...
#define ICON_MOB_BACKS_PATH 'modular_alliance/modules/alternative_textures/icons/mob/clothing/back.dmi'

/obj/item/storage/backpack/security
	icon = 'modular_alliance/modules/alternative_textures/icons/obj/storage.dmi'
